...
const Frame6 = () => {
  return (
    <div className="p-6 mt-10">
      ...
      <div className="flex justify-center gap-10 mt-16 p-4 text-center">
        <div>
          <h3 className="text-black text-[15px] mb-4 text-semibold ">Icons</h3>
        ...
        <div>
          <h3 className="text-black text-[15px] mb-4 text-semibold">Shoes</h3>
        ...
        <div>
          <h3 className="text-black text-[15px] mb-4 text-semibold">Clothing</h3>
